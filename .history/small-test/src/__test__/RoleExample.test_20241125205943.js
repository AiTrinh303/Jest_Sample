...
test('RoleExample renders all elements', () => {
    ...
    const footer = screen.getByRole('footer', {name: /footer/i});
    const heading1 = screen.getByRole('h1', {name: /heading 1/i});
    const header = screen.getByRole('header', {name: /header/i});
